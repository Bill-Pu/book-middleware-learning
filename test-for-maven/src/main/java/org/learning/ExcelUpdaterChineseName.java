...
public class ExcelUpdaterChineseName {
    ...
    public static void main(String[] args) {
        ...
        fColumnMap.put("28元立牌", 6);
        fColumnMap.put("28元满版立牌", 6);
        fColumnMap.put("36元立牌", 6);
        fColumnMap.put("58吧唧", 6);
        fColumnMap.put("75吧唧", 6);
        fColumnMap.put("多插立牌立牌", 6);
        fColumnMap.put("方吧唧", 6);
        fColumnMap.put("方卡", 6);
        ...
        fColumnMap.put("色纸", 6);
        fColumnMap.put("椭圆吧唧", 6);
        fColumnMap.put("像素人立牌", 6);
        fColumnMap.put("亚克力棒棒糖", 6);
        fColumnMap.put("亚克力双闪色纸", 6);
        fColumnMap.put("亚克力透卡", 6);
        ...
        eColumnMap.put("28元满版立牌", 28.0);
        eColumnMap.put("36元立牌", 36.0);
        eColumnMap.put("58吧唧", 15.0);
        eColumnMap.put("75吧唧", 16.0);
        eColumnMap.put("多插立牌立牌", 0.0);
